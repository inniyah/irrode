...
class CIrrOdeSurfaceParameterManager {
  private:
    ...
    CIrrOdeSurfaceParameterManager() {
    }

  public:
    static CIrrOdeSurfaceParameterManager *getSharedInstance() {
      static CIrrOdeSurfaceParameterManager theManager;
      return &theManager;
    }
