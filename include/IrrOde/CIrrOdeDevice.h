...
class COdeDataWrapper {
  public:
    ...
    dVector3 *m_pVertices;              /*!< a vertex irr::core::array. Used for trimeshes */
    u32 *m_pIndices;                    /*!< an index irr::core::array. Used for trimeshes */
    u32 m_iIndexCount,m_iVertexCount;   /*!< sizes of the vertex and index irr::core::array. Used for trimeshes */
};
...
class CFastCollision {
  public:
    ...
    irr::core::vector3df m_cPos;       /*!< the collision point of the bodies */
};
...
class CIrrOdeDevice : public IIrrOdeDevice {
  protected:
    irr::core::array<COdeDataWrapper *> m_pOdeData;
  ...
  public:
    ...
    static void quaternionToEuler(const dQuaternion q, irr::core::vector3df &v);  /**< convert quaternion to euler angles */
    static void eulerToQuaternion(const irr::core::vector3df v, dQuaternion q);   /**< convert euler angles to quaternion */
    ...
    virtual irr::core::vector3df jointGetBallAnchor(u32 iJoint);
    virtual irr::core::vector3df jointGetBallAnchor2(u32 iJoint);
    ...
    virtual irr::core::vector3df jointGetHingeAxis(u32 iJoint);
    virtual irr::core::vector3df jointGetHingeAnchor1(u32 iJoint);
    virtual irr::core::vector3df jointGetHingeAnchor2(u32 iJoint);
    ...
    virtual irr::core::vector3df jointGetHinge2Axis1(u32 iJoint);
    virtual irr::core::vector3df jointGetHinge2Axis2(u32 iJoint);
    virtual irr::core::vector3df jointGetHinge2Anchor(u32 iJoint);
    virtual irr::core::vector3df jointGetHinge2Anchor2(u32 iJoint);
    ...
    virtual irr::core::vector3df jointGetPistonAnchor(u32 iJoint);
    virtual irr::core::vector3df jointGetPistonAxis(u32 iJoint);

    virtual void jointSetSliderAxis(u32 iJoint, irr::core::vector3df a);
    virtual irr::core::vector3df jointGetSliderAxis(u32 iJoint);
    ...
    virtual irr::core::vector3df jointGetUniversalAnchor(u32 iJoint);
    virtual irr::core::vector3df jointGetUniversalAnchor2(u32 iJoint);
    virtual irr::core::vector3df jointGetUniversalAxis1(u32 iJoint);
    virtual irr::core::vector3df jointGetUniversalAxis2(u32 iJoint);
    ...
    virtual irr::core::vector3df jointGetPrAxis1(u32 iJoint);
    virtual irr::core::vector3df jointGetPrAxis2(u32 iJoint);
    virtual irr::core::vector3df jointGetPrAnchor(u32 iJoint);
    ...
    virtual irr::core::vector3df bodyGetPosition(u32 iBody);
    virtual irr::core::vector3df bodyGetRotation(u32 iBody);
    ...
    virtual const irr::core::vector3df bodyGetFiniteRotationAxis(u32 iBody);
    ...
    virtual irr::core::vector3df bodyGetLinearVelocity(u32 iBody);
    virtual void bodySetAngularVelocity(u32 iBody, irr::core::vector3df v);
    virtual irr::core::vector3df bodyGetAngularVelocity(u32 iBody);
    virtual irr::core::vector3df bodyGetPointVel(u32 iBody, irr::core::vector3df vPos);
    virtual irr::core::vector3df bodyGetRelPointVel(u32 iBody, irr::core::vector3df vPos);
    virtual irr::core::vector3df bodyGetRelPointPos(u32 iBody, irr::core::vector3df vPos);
    virtual irr::core::vector3df bodyGetPosRelPoint(u32 iBody, irr::core::vector3df vPos);
    virtual irr::core::vector3df bodyVectorFromWorld(u32 iBody, irr::core::vector3df vPos);
    ...
    virtual void geomSetCategoryBits(u32 iGeom, u32 iBits);
    virtual void geomSetCollisionBits(u32 iGeom, u32 iBits);

    virtual u32 geomGetCategoryBits(u32 iGeom);
    virtual u32 geomGetCollisionBits(u32 iGeom);
    ...
    virtual u32 spaceCreateQuadTree(u32 iParent, irr::core::vector3df center, irr::core::vector3df extends, s32 iDepth);
