...
class IRunner {
  ...
  public:
    IRunner(const wchar_t *sTitle) {
      m_pDevice=irr::createDevice(irr::video::EDT_OPENGL,irr::core::dimension2d<irr::u32>(640,480),16,false,false,false,0);
    ...
    virtual void setEventReceiver(irr::IEventReceiver *pReceiver)=0;
};
