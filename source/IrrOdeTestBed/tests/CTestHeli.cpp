...
CTestHeli::CTestHeli(irr::IrrlichtDevice *pDevice, IRunner *pRunner) : IState(pDevice, pRunner) {
...
bool CTestHeli::OnEvent(const irr::SEvent &event) {
  bool bRet=false;
...
bool CTestHeli::onEvent(irr::ode::IIrrOdeEvent *pEvent) {
...
bool CTestHeli::handlesEvent(irr::ode::IIrrOdeEvent *pEvent) {
